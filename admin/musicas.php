...
<!--    <div class="d-flex justify-content-between align-items-center mb-4">    -->
    <div class="mt-3 justify-content-between align-items-center mb-3">
        <h2 class="mb-2">Listagem de Músicas</h2>
        <a href="musicas_form.php" class="btn btn-success btn-sm mb-3">Cadastrar Nova Música</a> 
        <a href="index.php" class="btn btn-secondary btn-sm mb-3">⬅️ Voltar ao menu principal</a> 
<!--        <a href="index.php" class="btn btn-secondary btn-sm mb-3">Voltar à página anterior</a>   -->
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-3">
                <a href="musicas_visualizar.php?id=<?= $row['idMusica'] ?>" class="btn btn-secondary btn-sm">Visualizar</a>
                <a href="musicas_editar.php?id=<?= $row['idMusica'] ?>" class="btn btn-warning btn-sm">Editar</a>
                <a href="musicas_excluir.php?id=<?= $row['idMusica'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir esta música?')">Excluir</a>
            </div>
        </div>
    </div>
    <?php
