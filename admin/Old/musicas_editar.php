                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" 
                                   name="momentos[]" 
                                   value="<?php echo $momento['idMomento']; ?>" 
                                   id="momento_<?php echo $momento['idMomento']; ?>"
                                   <?php echo in_array($momento['idMomento'], $momentosMarcados) ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="momento_<?php echo $momento['idMomento']; ?>">
                                <?php echo htmlspecialchars($momento['DescMomento']); ?>
                            </label>
                        </div>
                    </div>
                <?php endforeach; ?>
