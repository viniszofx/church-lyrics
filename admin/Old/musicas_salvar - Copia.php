...
if ($id > 0) {
    ...
    foreach ($momentosSelecionados as $idMomento) {
        ...
        $conn->query("INSERT INTO tbMusicaMomentoMissa (idMusica, idMomento) VALUES ($id, $idMomento)");
    }
    ...
    foreach ($momentosSelecionados as $idMomento) {
        $idMomento = intval($idMomento);
        $conn->query("INSERT INTO tbMusicaMomentoMissa (idMusica, idMomento) VALUES ($idNovaMusica, $idMomento)");
    }
