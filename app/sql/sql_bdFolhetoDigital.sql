...
CREATE TABLE IF NOT EXISTS `tbcifras` (
  ...
  `TomMusica` varchar(5) DEFAULT NULL,
  `DescMusicaCifra` text DEFAULT NULL,
  `DescMusicaCifraHtml` text DEFAULT NULL,
  PRIMARY KEY (`idCifra`),
...
-- Copiando dados para a tabela bdfolhetodigital.tbcifras: ~1 rows (aproximadamente)
DELETE FROM `tbcifras`;
INSERT INTO `tbcifras` (`idCifra`, `idMusica`, `TomMusica`, `DescMusicaCifra`, `DescMusicaCifraHtml`) VALUES
	(1, 4, 'D', 'Intro:  D  G  A  D\r\n\r\n                   D               G                  A                   D\r\n1. Senhor tende piedade e perdoai a nossa culpa.\r\n                 G                  A7    D   D7     \r\n    E perdoai a nossa cul...pa, \r\n\r\n                           G                      A  A7    D \r\n    Porque nós somos vosso Po.........vo,\r\nBm                   Em                    A    D\r\n    Que vem pedir vosso perdã.....ão.\r\n\r\n\r\n                  D              G                  A                   D\r\n2. Cristo tende piedade e perdoai a nossa culpa.\r\n                 G                  A7    D   D7     \r\n    E perdoai a nossa cul...pa, \r\n\r\n                   D               G                  A                   D\r\n3. Senhor tende piedade e perdoai a nossa culpa.\r\n                 G                  A7    D   D7     \r\n    E perdoai a nossa cul...pa,', NULL);
...
-- Copiando dados para a tabela bdfolhetodigital.tbigrejasacerdote: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela bdfolhetodigital.tbmissamusicas: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela bdfolhetodigital.tbmomentosmissa: ~15 rows (aproximadamente)
...
-- Copiando dados para a tabela bdfolhetodigital.tbmusica: ~33 rows (aproximadamente)
...
INSERT INTO `tbmusica` (`idMusica`, `NomeMusica`, `Musica`) VALUES
	...
	(7, 'Senhor Que Viste Salvar', '1. Senhor que vieste salvar os corações arrependidos. \r\nTende piedade de nós!\r\n[negrito]\r\nSenhor, tende piedade, tende piedade,\r\nPiedade de nós!\r\nPiedade de nós!\r\n[/negrito]\r\n2.Cristo, que vieste chamar os pecadores, \r\nTende piedade de nós.\r\n[negrito]\r\nCristo, tende piedade, tende piedade,\r\nPiedade de nós!\r\nPiedade de nós!\r\n[/negrito]\r\n3. Senhor que intercedei por nós junto do pai,\r\nTende piedade de nós.\r\n[negrito]\r\nSenhor, tende piedade, tende piedade,\r\nPiedade de nós!\r\nPiedade de nós!\r\n[/negrito]'),
	...
	(14, 'A...a...a, A...a...a, A.a.a.a.mém', 'A.a.a.a.mém, A.a.a.a.mém\r\nA...a...a, 	A...a...a, A.a.a.a.mém\r\nA...a...a,	A...a...a, A.a.a.a.mém\r\nA.mém, A.mém'),
	...
	(28, 'Tu Anseias', 'Tu anseias, eu bem sei, por salvação\r\nTens desejo de banir a escuridão\r\nAbre, pois, de par em par, teu coração\r\nE deixa a luz do céu entrar\r\n[negrito]\r\nDeixa a luz do céu entrar (deixa a luz céu entrar)\r\nDeixa a luz do céu entrar (deixa a luz céu entrar)\r\nAbre bem as portas do teu coração\r\nE deixa a luz do céu entrar\r\n[/negrito]\r\nCristo, a luz do céu, em ti quer habitar\r\nPara as trevas do pecado dissipar\r\nTeu caminho e coração iluminar\r\nE deixa a luz do céu entrar\r\n[negrito][refrão][/negrito]'),
	...
	(32, 'Pelas estradas da vida', 'Pelas estradas da vida, \r\nnunca sozinho estás\r\nContigo pelo caminho, \r\nSanta Maria vai\r\n[negrito]\r\nOh vem conosco vem caminhar, \r\nSanta Maria vem\r\nOh vem conosco vem caminhar\r\nSanta Maria vem,\r\n[/negrito]\r\nSe pelo mundo os homens, \r\nsem conhecer-se, vão\r\nNão negues nunca a tua mão, \r\na quem te encontrar\r\n[negrito][refrão][/negrito]\r\n\r\nMesmo que digam os homens,\r\nTu nada podes mudar,\r\nLuta por um mundo novo\r\nDe unidade e paz\r\n[negrito][refrão][/negrito]\r\n\r\nSe parecer tua vida\r\nInútil caminhar\r\nLembra que abres caminho\r\nOutros te seguirão\r\n[negrito][refrão][/negrito]'),
	(33, 'Pelas estradas da vida', 'Pelas estradas da vida, \r\nnunca sozinho estás\r\nContigo pelo caminho, \r\nSanta Maria vai\r\n[negrito]\r\nOh vem conosco vem caminhar, \r\nSanta Maria vem\r\nOh vem conosco vem caminhar\r\nSanta Maria vem,\r\n[/negrito]\r\nSe pelo mundo os homens, \r\nsem conhecer-se, vão\r\nNão negues nunca a tua mão, \r\na quem te encontrar\r\n[negrito][refrão][/negrito]\r\n\r\nMesmo que digam os homens,\r\nTu nada podes mudar,\r\nLuta por um mundo novo\r\nDe unidade e paz\r\n[negrito][refrão][/negrito]\r\n\r\nSe parecer tua vida\r\nInútil caminhar\r\nLembra que abres caminho\r\nOutros te seguirão\r\n[negrito][refrão][/negrito]'),
	(34, 'Pelas estradas da vida', 'Pelas estradas da vida, \r\nnunca sozinho estás\r\nContigo pelo caminho, \r\nSanta Maria vai\r\n[negrito]\r\nOh vem conosco vem caminhar, \r\nSanta Maria vem\r\nOh vem conosco vem caminhar\r\nSanta Maria vem,\r\n[/negrito]\r\nSe pelo mundo os homens, \r\nsem conhecer-se, vão\r\nNão negues nunca a tua mão, \r\na quem te encontrar\r\n[negrito][refrão][/negrito]\r\n\r\nMesmo que digam os homens,\r\nTu nada podes mudar,\r\nLuta por um mundo novo\r\nDe unidade e paz\r\n[negrito][refrão][/negrito]\r\n\r\nSe parecer tua vida\r\nInútil caminhar\r\nLembra que abres caminho\r\nOutros te seguirão\r\n[negrito][refrão][/negrito]');
...
-- Copiando dados para a tabela bdfolhetodigital.tbmusicamomentomissa: ~33 rows (aproximadamente)
...
-- Copiando dados para a tabela bdfolhetodigital.tbtempomusica: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela bdfolhetodigital.tbvideo: ~2 rows (aproximadamente)
DELETE FROM `tbvideo`;
...
CREATE TABLE `viewmusicas` (
	...
	`DescMusicaCifraHtml` TEXT NULL COLLATE 'utf8mb4_general_ci',
	`DescTempo` VARCHAR(1) NULL COLLATE 'utf8mb4_general_ci',
	`Sigla` VARCHAR(1) NULL COLLATE 'utf8mb4_general_ci'
);
